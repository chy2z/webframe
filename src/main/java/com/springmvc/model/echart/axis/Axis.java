...
import com.springmvc.model.echart.Component;
import com.springmvc.model.echart.code.AxisType;
import com.springmvc.model.echart.code.X;
import com.springmvc.model.echart.code.Y;
...
public abstract class Axis<T> extends AbstractData<T> implements Component {
     ...
     *
     * @see com.springmvc.model.echart.code.AxisType
     */
    private AxisType type;
    /**
     * 坐标轴类型，横轴默认为类目型'bottom'，纵轴默认为数值型'left'，可选为：'bottom' | 'top' | 'left' | 'right'
     *
     * @see com.springmvc.model.echart.code.X
     * @see com.springmvc.model.echart.code.Y
     */
     ...
     *
     * @see com.springmvc.model.echart.axis.AxisLine
     ...
     *
     * @see com.springmvc.model.echart.axis.AxisLabel
     */
