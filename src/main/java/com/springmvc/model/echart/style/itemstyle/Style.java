...
import com.springmvc.model.echart.style.*;
...
public abstract class Style<T> implements Serializable {
     ...
     * 饼图标签视觉引导线，默认显示
     *
     * @see com.springmvc.model.echart.LabelLine
     */
     ...
     * 和弦图 - 弦样式
     *
     * @see com.springmvc.model.echart.style.ChordStyle
     */
    private ChordStyle chordStyle;
    /**
     * 力导向图 - 弦样式
     *
     * @see com.springmvc.model.echart.style.NodeStyle
     */
    private NodeStyle nodeStyle;
    /**
     * 力导向图 - 弦样式
     *
     * @see com.springmvc.model.echart.style.LinkStyle
     */
