    ...
    new Vue({
        ...
        data: {
            ...
            auditProcess:{
                ...
                departName:"${requestScope.kindProcess.departname}",
                kind:"${requestScope.kindProcess.auditkind}",
                kid:${requestScope.kindProcess.kid},
                departid:${requestScope.kindProcess.departid},
                enable:"${requestScope.kindProcess.enable}"=="启用",
                stepNum:${requestScope.kindProcess.stepnum}
            },
            dragTable: {
                hasDragged: false,
                isDragging: false,
        ...
        mounted:function () {
            ...
            vDelay(1000,()=>{
                ...
                selectHelperATDepartment.setSelectItem(this.auditProcess.departid);
            },()=>{
                this.spinShow=false;
            });
        },
